...
{
    public partial class FormPoinAndRectangle : Form
    {
        public FormPoinAndRectangle()
        {
            InitializeComponent();
        }
        ...
        private void FormPoinAndRectangle_Load(object sender, EventArgs e)
        {
            Draw();
        }

        private void FormPoinAndRectangle_Resize(object sender, EventArgs e)
        {
            Draw();
        }
